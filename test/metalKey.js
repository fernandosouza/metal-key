...
describe('MetalKey', function() {
	describe('From JavaScript binding', function() {
		...
		it('should pass thought the event object the custom event used', function(done) {
			var element = document.createElement('input');
			dom.enterDocument(element);
	...
	describe('From IncrementalDOM binding', function() {
		it('should listen to the keydown event from a component using (onEventname) pattern', function() {
		...
		it('should listen to the keydown event from a component using (data-on-eventname) pattern', function() {
			class TestComponent extends Component {
				render() {
					IncDom.elementOpen('div');
